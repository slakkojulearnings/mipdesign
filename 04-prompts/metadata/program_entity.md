...
> Prompt 11 · Category: Metadata · Skill: [metadata-modeler](../../03-skills/metadata-modeler/SKILL.md)
...
- **Evidence Envelope** (per [principles](../../03-skills/MIP_ENGINEERING_PRINCIPLES.md)): source_evidence · discovery_method · confidence · validation_status · discovered_at
