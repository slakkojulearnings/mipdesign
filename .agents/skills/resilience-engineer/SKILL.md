...
description: "Identifies single points of failure, recovery paths, critical processing windows, and a resilience score from graph and operational evidence. Use when assessing operational risk or recovery readiness."
