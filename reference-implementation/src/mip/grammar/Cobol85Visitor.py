...
class Cobol85Visitor(ParseTreeVisitor):
    ...
    def visitDataOccursDepending(self, ctx:Cobol85Parser.DataOccursDependingContext):
        return self.visitChildren(ctx)
    ...
    def visitDataOccursIndexed(self, ctx:Cobol85Parser.DataOccursIndexedContext):
        return self.visitChildren(ctx)
    ...
    def visitStopStatementGiving(self, ctx:Cobol85Parser.StopStatementGivingContext):
        return self.visitChildren(ctx)
    ...
    def visitSubscript(self, ctx:Cobol85Parser.SubscriptContext):
        return self.visitChildren(ctx)
