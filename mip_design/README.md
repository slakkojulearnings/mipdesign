# MIP — Mainframe Intelligence Platform (consolidated design)
...
>
> This `mip_design/` folder is the **single source of truth**: philosophy, principles,
...
| [`reference-implementation/`](reference-implementation/) | **runnable** v0.1 (Python 3.13) + `sample_estate/` + tests |
