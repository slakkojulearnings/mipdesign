---
name: code-reviewer
description: "Reviews designs and code for correctness, scalability, maintainability, and conformance to MIP principles (evidence/confidence, resilience, explainability). Use for design or PR review and pre-production risk assessment."
