...
description: "Turns discovery, graph, and risk evidence into incremental, low-risk modernization strategy: service boundaries, APIs, events, strangler plans, sequencing. Use when planning what to modernize first, decomposing domains, or producing a migration roadmap."
