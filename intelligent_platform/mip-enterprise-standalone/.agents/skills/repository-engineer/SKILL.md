...
description: "Designs repository and workspace structure, the skills registry and prompt-library layout, and dependency rules. Use when organizing the repo, easing onboarding, or governing structure."
