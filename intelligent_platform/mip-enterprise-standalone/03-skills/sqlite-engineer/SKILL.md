...
description: "Designs the SQLite (to PostgreSQL) persistence for metadata plus the evidence envelope, indexes, and graph-ready queries. Use when defining storage, schema DDL, migration, or query performance."
